...
namespace Client.Scenes
{
    ...
    public sealed class GameScene : DXScene
    {
        ...
        /// 道士动态BUFF
        /// </summary>
        public LeftBuffBox LeftBuffBox;
        /// <summary>
        /// 聊天信息框
        /// </summary>
        ...
        /// 加载时的动画
        /// </summary>
        public LoadingObject LoadingAnimation;
        /// <summary>
        /// 背包格子数量定义
        /// </summary>
        ...
        /// 自动挂机快捷键开关
        /// </summary>
        public bool ZidongguajiAutoRun
        {
            get => _ZidongguajiAutoRun;
            set
            {
                if (_ZidongguajiAutoRun == value) return;
                _ZidongguajiAutoRun = value;

                ReceiveChat(value ? "开始".Lang() : "关闭".Lang(), MessageType.Hint);
            }
        }
        private bool _ZidongguajiAutoRun;
        ...
        public MagicType ContinuouslyMagicType = MagicType.None;
        #endregion
        ...
        public void Init()
        {
            ...
            {
                Parent = this,
                Visible = BigPatchConfig.ChkDisplayOthers
            };
        ...
        private void SetDefaultLocations()
        {
            ...
            MarketSearchBox.Location = new Point((Size.Width - MarketSearchBox.Size.Width) / 2, (Size.Height - MarketSearchBox.Size.Height) / 2);
            ...
            CommunicationBox.Location = new Point(0, (Size.Height - CommunicationBox.Size.Height) / 2);
            ...
            BonusPoolVersionBox.Location = new Point(0, 0);
        ...
        public override void Process()
        {
            ...
            //顶部标签 时间
            if (BigPatchConfig.ChkDisplayOthers && TopInfoBox.TimeLabel != null)
            {
                TopInfoBox.TimeLabel.Text = $"Cenvir.TimeLabel".Lang(DateTime.Now.ToString("HH:mm:ss"));
            }
            ...
            if (LoadingAnimation != null && CEnvir.Now - LoadingAnimation.animation.AnimationStart > LoadingAnimation.Duration)
            {
                LoadingAnimation.animation.Visible = false;
            }
        ...
        public override void OnKeyDown(KeyEventArgs e)
        {
            ...
            foreach (KeyBindAction action in CEnvir.GetKeyAction(e.KeyCode))
            {
                switch (action)
                {
                    ...
                    case KeyBindAction.Zidongguaji:  ///快捷键自动挂机 qq715590
                        if (Observer) continue;
        ...
        private void EquipmentItemInfo(string prefix = "")
        {
            ...
            void DrawFullItemStat(FullItemStat fullItemStat)
            {
                ...
                label = new DXLabel
                {
                    ...
                    Location = new Point(4, ItemLabel.DisplayArea.Bottom),
                    Parent = ItemLabel,
                    Text = (isGem || isOther) ? (prefix + text) : text
                };
        ...
        public void UseMagic(SpellKey key)
        {
            ...
            //持续施法，切换魔法
            //if (ContinuouslyMagic && ContinuouslyMagicType != magic.Info.Magic)
            //    ContinuouslyMagicType = MagicType.None;
            if (magic != null)
        ...
        public void ShowLoadingAnimation(int duration)
        {
            ...
            {
                LoadingAnimation = new LoadingObject(duration, this);
                LoadingAnimation.animation.Location = new Point(Size.Width / 2 - LoadingAnimation.animation.Size.Width / 2, Size.Height / 2);
            }
            LoadingAnimation.Duration = TimeSpan.FromSeconds(duration);
            LoadingAnimation.animation.Visible = true;
            LoadingAnimation.animation.AnimationStart = CEnvir.Now;
            LoadingAnimation.animation.BringToFront();
        }
        ...
        public void UseMagic(ClientUserMagic magic)
        {
            ...
            switch (magic.Info.Magic)
            {
                ...
                case MagicType.DanceOfSwallow:
                    ...
                    return;
                case MagicType.Purification:  //云寂术修改成鼠标锁定角色对象
