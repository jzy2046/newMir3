...
def OnProcessAI(args):
	...
	if select == 0 and hp_percent < 30 and not monster.Target is None:
		#刷出新的怪物
		monster.CurrentMap.CreateMon(monster.CurrentLocation.X,monster.CurrentLocation.Y,0,100454,1)
		SEnvir.ScheduledCall("Mon.怪物监视.男性诺玛.DelayClearMonster", SEnvir.Now.AddMilliseconds(1), monster)
...
MonsterEvent.add_listener(100418,"OnProcessAI",OnProcessAI)
