...
def OnEnter(args):            #进入
	...
	Server.Envir.SEnvir.DelayCall("Map.抗拒火环1.CloseFuben",300,(map,))   #地图总时间 秒为单位
...
def MonsterCount(args):         #怪物总数
	...
	try:
		...
		Server.Envir.SEnvir.DelayCall("Map.抗拒火环1.MonsterCount",3,(map,Sender,))
	except Exception as ex:
		SEnvir.Log("出现如下异常%s"%ex)
		return

MapEvent.add_listener(513,"OnEnter",OnEnter)		
