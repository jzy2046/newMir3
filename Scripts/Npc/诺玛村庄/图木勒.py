...
#跳转菜单1商品	
		...
		say = """人类铁匠打造的武器决不能和我卖的武器相提并论，我这里都
		是好货色，你尽管挑吧。
...
#跳转菜单2修理				
		...
		say = """勇士一定要好好保养自己的武器。把你想要修理的武器放上
		来吧，我会让它恢复原样。
...
#跳转菜单3卖				
		...
		say = """你真的这么急需用钱，竟然到了出售自己武器的地步？人类只
		知道钱、钱...
		如果真的是急需用钱，就让我来帮你吧。把要出售的武器抬上
		来。
...
NpcEvent.add_listener(179,"OnClick",OnClick)