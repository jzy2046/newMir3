...
#主菜单
		...
		<font color=\"0xff00ff00\">功能介绍：</font>
		• 回购玩家出售到商店的物品
		• 按原价回购，无额外费用
		• 支持武器、防具、首饰、书籍、杂货等
		• 回购物品数量无限制
		
		<font color=\"0xff00ff00\">使用说明：</font>
		点击下方按钮进入对应分类，查看可回购的物品列表。
		
		<font color=\"0xff00ff00\">重要提示：</font>
		• 自动回收的物品不会进入回购
		• 一键售卖和向NPC出售的物品会进入回购
		• 游戏重启后，回购列表将被清空
...
NpcEvent.add_listener(324,"OnClick",OnClick)
NpcEvent.add_listener(325,"OnClick",OnClick)
