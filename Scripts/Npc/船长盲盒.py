...
def OnClick(args):
	...
	if (Menu == 1):
		if (Sender.Gold < 200000):
			...
			# 发奖
			Sender.PYMailSend("船长盲盒", "运营团队", "你打开了船长盲盒, 请领取你的奖励", my_reward)
			BroadChat('恭喜玩家 {} 开启船长盲盒，获得 {}'.format(Sender.Name, my_reward[0][0]))
			return
#主菜单
	else:
		say = """[20万金币开启船长盲盒:1]"""
...
NpcEvent.add_listener(367,"OnClick",OnClick)