...
#飞	
		...
		if (Sender.Gold < 500):
			...
			SubGold(Sender,500)
			Sender.TeleportByMapIndex(46,269,730)
			return
	elif(Menu == 10):
		if (Sender.Gold < 2500):
			say = """你没有足够的金币，无法传送。
...
#主菜单	
		...
		[移动至沙漠土城所需金钱：500金币:7]
		[移动至蚂蚁洞穴入口所需金钱：500金币:9]
		
		[移动至盟重土城所需金钱：1000金币:6]
		[移动至边境城市所需金钱：1500金币:3]
		
		[移动至比奇城所需金钱：2000金币:1]
		[移动至潘夜岛所需金钱：2000金币:5]
		
		[移动至道馆所需金钱：2500金币:8]
		[移动至毒蛇山谷所需金钱：2500金币:4]
		[移动至银杏山谷所需金钱：2500金币:2]
		[移动至诺玛村庄所需金钱：2500金币:10]
...
NpcEvent.add_listener(16,"OnClick",OnClick)